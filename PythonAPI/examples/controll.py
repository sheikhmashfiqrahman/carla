...
try: 
    ...
    #Draw_waypoints method helps us find a good spawn location for vehicles

    def draw_waypoints(waypoints, road_id=None, life_time=50):
    ...
    custom_controller = VehiclePIDController(vehicle, args_lateral = {'K_P': 1, 'K_D': 0.00, 'K_I': 0.0}, args_longitudinal = {'K_P': 1, 'K_D': 0.0, 'K_I': 0})
    ...
    while True:
        ...
        world.debug.draw_string(target_waypoint.transform.location, 'O', draw_shadow=False,
                            ...
                            persistent_lines=True)
        control_signal = custom_controller.run_step(5, target_waypoint)
